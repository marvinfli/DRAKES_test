...
OUTPUT_DIR="model_comparison_diff_steps_${TIMESTAMP}"

echo "========================================"
echo "Configuration:"
echo "  Config file: experiments/marvin/250804/eval_config_all.yaml"
echo "  Output directory: $OUTPUT_DIR"
echo "  Base path: $BASE_PATH"
echo "========================================"

# Run evaluation
python run_evaluation.py experiments/marvin/250804/eval_config_all.yaml --output_dir "$OUTPUT_DIR"
